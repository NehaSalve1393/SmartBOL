...
public class PolygonView extends FrameLayout {
    ...
    private void init() {
        ...
        midPointer13.setOnTouchListener(new PolygonView.MidPointTouchListenerImpl(pointer1, pointer3));

        midPointer12 = getImageView(0, getWidth() / 2);
        midPointer12.setOnTouchListener(new PolygonView.MidPointTouchListenerImpl(pointer1, pointer2));

        midPointer34 = getImageView(0, getHeight() / 2);
        midPointer34.setOnTouchListener(new PolygonView.MidPointTouchListenerImpl(pointer3, pointer4));

        midPointer24 = getImageView(0, getHeight() / 2);
        midPointer24.setOnTouchListener(new PolygonView.MidPointTouchListenerImpl(pointer2, pointer4));
    ...
    private ImageView getImageView(int x, int y) {
        ...
        imageView.setImageResource(com.scanlibrary.R.drawable.circle);
        imageView.setX(x);
        imageView.setY(y);
        imageView.setOnTouchListener(new PolygonView.TouchListenerImpl());
        return imageView;
    }
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints())) {
                        color = getResources().getColor(com.scanlibrary.R.color.blue);
                    } else {
                        color = getResources().getColor(com.scanlibrary.R.color.orange);
                    }
